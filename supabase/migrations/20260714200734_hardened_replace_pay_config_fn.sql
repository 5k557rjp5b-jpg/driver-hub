-- Driver Hub — hardened replace_pay_configuration (advisory lock)
-- Applied directly to production (kfefxjhowtyrpmddlivw) on 2026-07-14.
-- This is the same function body as 20260712110000_replace_pay_config_fn.sql;
-- captured here as its own migration because production had been running
-- an earlier, non-locking version of this function until this date.
